...
Sample output is lifted from a real recorded run (`docs/captures/COMMANDS_showcase_2026-09-09.md`), trimmed to the first few lines and
...
_The directory-as-knowledge-base pattern: --recall pointed at a 1992228-byte scratch dir of DUMPED TOOL OUTPUT (a git log, this repo's own generated command reference, --help text, an architecture doc, a fabricated JSON access log) instead of a source repo — no index to build, no daemon._
